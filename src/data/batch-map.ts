...
export const BATCH_MAP: Record<string, BatchTag> = {
  ...
  'A.名單成效.方案總覽': { batch: 'p2', source: '#6 IoT + #1 SF + 行銷方案主檔', note: '方案/名單規則待中台建表' },
  'A.名單成效.寄發漏斗': { batch: 'p2', source: '報告引擎 + 寄發系統', note: '寄達/開啟需寄發回條與埋點' },
  'A.名單成效.CTA成效': { batch: 'p2', source: '報告引擎埋點', note: '報告內 CTA 環圈點擊尚未埋點' },
  'A.名單成效.服務跟進': { batch: 'p2', source: '#1 SF Work__c / RepairOrder__c', note: 'CTA→服務單的歸因規則待定' },
