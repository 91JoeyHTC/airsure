...
- **9/18 首批報告寄送計畫**：`docs/aircare-0918-報告寄送計畫.md`（30–60 位手動挑選 · LINE／簡訊／Email 三通路 · 報告站建在 Cloudflare Pages Functions + D1，不走中台）。
  ⚠ 內含一個阻斷級問題：現行 AirCare 報告的**濕度分數全被算成 0.0**，封面總分低了 42–49 分，報告自己的內頁明細表就能推翻自己的封面。寄送前必修。
